...
package link.infra.ogidni.renderer;

import java.util.HashMap;

import link.infra.ogidni.renderer.mesh.MeshBuilderImpl;
 ...
 */
public class OgidniRenderer implements Renderer {
	public static final OgidniRenderer INSTANCE = new OgidniRenderer();
