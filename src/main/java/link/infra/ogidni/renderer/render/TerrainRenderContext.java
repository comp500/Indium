 ...
 */
public class TerrainRenderContext extends link.infra.ogidni.renderer.render.AbstractRenderContext implements RenderContext {
	public static final ThreadLocal<TerrainRenderContext> POOL = ThreadLocal.withInitial(TerrainRenderContext::new);
	private final TerrainBlockRenderInfo blockInfo = new TerrainBlockRenderInfo();
	private final link.infra.ogidni.renderer.render.ChunkRenderInfo chunkInfo = new ChunkRenderInfo();
