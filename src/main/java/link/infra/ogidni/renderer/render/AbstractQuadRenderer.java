...
import static link.infra.ogidni.renderer.helper.GeometryHelper.LIGHT_FACE_FLAG;
...
public abstract class AbstractQuadRenderer {
	...
	protected final link.infra.ogidni.renderer.render.BlockRenderInfo blockInfo;
