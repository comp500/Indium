 ...
 */
public abstract class BufferFallbackConsumer extends BufferQuadRenderer implements Consumer<BakedModel> {
	...
	BufferFallbackConsumer(BlockRenderInfo blockInfo, Function<RenderLayer, VertexConsumer> bufferFunc, AoCalculator aoCalc, QuadTransform transform) {
