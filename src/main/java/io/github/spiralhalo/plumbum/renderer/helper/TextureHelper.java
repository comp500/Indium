 ...
 * via {@link #bakeSprite(QuadEmitter, Sprite, int)}. Also used by the API
...
public class TextureHelper {
	 ...
	 */
	public static void bakeSprite(QuadEmitter quad, Sprite sprite, int bakeFlags) {
	 ...
	 */
	private static void interpolate(QuadEmitter q, Sprite sprite) {
